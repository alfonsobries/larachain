...
>
    ...
    @foreach($menuItems as $item)
        <a
            ...
            class="flex py-3 pl-3 pr-4 text-base font-medium text-gray-800 transition duration-150 ease-in-out border-l-4 border-red-800 bg-gray-50 focus:outline-none focus:text-gray-600 focus:bg-gray-100 focus:border-gray-300"
            @else
    ...
    @guest
    <div class="flex flex-col p-4 space-y-4 border-t border-gray-100">
