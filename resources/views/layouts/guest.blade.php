<x-empty-layout>
    <div class="min-h-screen bg-gray-100 dark:bg-gray-800">
        ...
        <div>
            @isset($header)
                <header class="py-10 bg-white shadow-sm dark:bg-gray-900">
                    {{ $header }}
                </header>
            @endisset
            <main>
        ...
        <footer>
            <x-container>
                <div class="flex items-center justify-center font-mono text-sm text-center text-gray-600 dark:text-gray-400">
                    <span class="items-center hidden px-3 sm:inline-flex">
                        Made with
                        <svg viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 mx-1 text-red-800 dark:text-red-500">
                    ...
                    <a rel="noopener" href="https://github.com/alfonsobries/larachain" target="_blank"
                        class="inline-flex items-center px-3 text-gray-500 underline border-l border-gray-300 dark:text-gray-300"><svg
